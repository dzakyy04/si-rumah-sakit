        ...
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des">
                    <p>You have total {{ $totalPatients }} ipd patients in hospital.</p>
                </div>
            </div>

            <a href="{{ route('patient.create') }}" class="btn btn-primary mt-2">
                <span class="ni ni-plus fs-4"></span>
                <span class="ms-1">Add Patient</span>
            </a>
        </div>
                ...
                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                    <thead>
                        <tr class="nk-tb-item nk-tb-head">
                            ...
                            <th class="nk-tb-col tb-col-lg"><span class="sub-text">Reason For Admission</span></th>
